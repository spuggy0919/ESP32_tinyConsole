...
char sendcr = 0;
short blockmode = 0; /*spuggy0919*/

/*  handling time, remember when we started, needed in millis() */
struct timeb start_time;					/**spuggy0919**/
// void timeinit() { ftime(&start_time); } /**spuggy0919**/
void getftime(struct timeb *tm); /**spuggy0919**/
#define ftime getftime /**spuggy0919**/
void timeinit() {ftime(&start_time); } /**spuggy0919**/
