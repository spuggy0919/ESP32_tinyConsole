 ...
 */
typedef unsigned char uint8_t; /*spuggy0919*/
// typedef unsigned long  uint64_t; /*spuggy0919*/
...
const char mprompt[]	PROGMEM = "> "; /*spuggy0919*/
...
#ifdef ARDUINO /*spuggy0919*/
int bargc;
char** bargv;
mem_t bnointafterrun = 0; // original is 0  spuggy0919
#endif
...
void radioset(int);
#ifdef ARDUINO 
unsigned long pipeaddr(char*); //uint64_t *spuggy0919*
#else
long pipeaddr(char*);
#endif
